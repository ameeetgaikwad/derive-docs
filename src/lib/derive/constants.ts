...
interface DeriveConfig {
  ...
  cbbtcAddress: `0x${string}`;
  cbbtcCashAsset: `0x${string}`;
  matching: `0x${string}`;
...
export const DERIVE_CONFIG: Record<DeriveEnv, DeriveConfig> = {
  testnet: {
    ...
    // TODO: Look up portfolioManager address from Derive testnet API
    ...
    // TODO: Look up BTC/CBBTC addresses on Derive testnet
    wbtcAddress: "0x0000000000000000000000000000000000000000",
    wbtcCashAsset: "0x0000000000000000000000000000000000000000",
    cbbtcAddress: "0x0000000000000000000000000000000000000000",
    cbbtcCashAsset: "0x0000000000000000000000000000000000000000",
  ...
  mainnet: {
    ...
    portfolioManager: "0xC7adAB7A2b92019098dA55Ba4C5A8C65Ae7e52DC",
    ...
    // "BTC" on Derive chain (generic wrapped BTC)
    wbtcAddress: "0x9b80ab732a6F1030326Af0014f106E12C4Db18EC",
    wbtcCashAsset: "0x7da2D398dddDfC946Efd2C758c4688D21887790d",
    // CBBTC (Coinbase wrapped BTC) on Derive chain
    cbbtcAddress: "0x1EA87f372285409425771F19Eb7938b427DAb148",
    cbbtcCashAsset: "0xC1efE4c45B79250A29A5Dc66cCADc60DB0FcEEe8",
    matching: "0xeB8d770ec18DB98Db922E9D83260A585b9F0DeAD",
...
// BTC variants use 8 decimals
export const WBTC_DECIMALS = 8;
export const CBBTC_DECIMALS = 8;

export type MarginType = "SM" | "PM" | "PM2";

export type SupportedAsset = "USDC" | "WBTC" | "CBBTC";
...
export function getAssetConfig(assetName: SupportedAsset, env?: DeriveEnv): AssetConfig {
  ...
  switch (assetName) {
    ...
    case "CBBTC":
      return { assetName: "CBBTC", tokenAddress: config.cbbtcAddress, cashAsset: config.cbbtcCashAsset, decimals: CBBTC_DECIMALS };
  }
}
